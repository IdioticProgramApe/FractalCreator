...
namespace IPA
{
	struct BitmapInfoHeader
	{
		...
		int32_t horizontalResolution{ 2400 };	// the horizontal resolution of the image (pixel per meter, signed integer)
		int32_t verticalResolution{ 2400 };		// the vertical resolution of the image (pixel per meter, signed integer)
